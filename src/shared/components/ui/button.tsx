  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/40 active:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-editor-outline bg-editor-surface text-foreground hover:bg-editor-surface-variant aria-expanded:bg-editor-surface-variant",
        secondary:
        ...
        ghost:
          "text-foreground hover:bg-editor-surface-variant/80 hover:text-foreground aria-expanded:bg-editor-surface-variant aria-expanded:text-foreground",
        destructive:
